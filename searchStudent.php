<?php
	...
	if (!$data) {
		//输出提示,跳转到首页
		echo "没有这个学生!<br><br>";
		header('Refresh: 1.5; url=index.php');//3s后跳转
		exit();
	}
	//将二维数数组转化为一堆数组
				...
				<form action="index.php" method="post" enctype="multipart/form-data">
					<table border="1" cellpadding="0" cellspacing="0">
						...
						<tr>
							<th>姓名:</th>
							<td>
								<input type="text" name="name" size="25" value="<?php echo $arr["name"] ?>" readonly="readonly">
							</td>
						</tr>
						<tr>
							<th>性别:</th>
						...
						<tr>
							<th>年龄:</th>
							<td>
								<input type="text" name="age" size="25" value="<?php echo $arr["age"] ?>" readonly="readonly">
							</td>
						</tr>
						<tr>
							<th>学历:</th>
