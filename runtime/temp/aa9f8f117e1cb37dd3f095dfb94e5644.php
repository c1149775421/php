<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:104:"D:\BaiduNetdiskDownload\phpPath\phpstudy_pro\WWW\blog\public/../application/admin\view\admin\modify.html";i:1606271412;s:102:"D:\BaiduNetdiskDownload\phpPath\phpstudy_pro\WWW\blog\public/../application/admin\view\common\top.html";i:1607488088;s:103:"D:\BaiduNetdiskDownload\phpPath\phpstudy_pro\WWW\blog\public/../application/admin\view\common\left.html";i:1619966632;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('Admin/update',array('id'=>$admin['id'])); ?>" method="post">
                          <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">管理员名称</label>
                            <div class="col-sm-6">
                                <input value=<?php echo $admin['username']; ?> class="form-control" id="username" placeholder="" name="username" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input value=<?php echo $admin['password']; ?> class="form-control" id="password" placeholder="" name="password" required="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
