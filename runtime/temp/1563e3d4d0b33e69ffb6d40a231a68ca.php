<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:103:"D:\BaiduNetdiskDownload\phpPath\phpstudy_pro\WWW\blog\public/../application/admin\view\article\add.html";i:1607480526;s:102:"D:\BaiduNetdiskDownload\phpPath\phpstudy_pro\WWW\blog\public/../application/admin\view\common\top.html";i:1607488088;s:103:"D:\BaiduNetdiskDownload\phpPath\phpstudy_pro\WWW\blog\public/../application/admin\view\common\left.html";i:1607480624;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal" role="form" action="<?php echo url('Article/add'); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
						     ...
						     <div class="col-sm-6">
						         <input class="form-control" id="des" placeholder="" name="des" required="" type="text">
						     </div>
						 </div> 
						 ...
						 <div class="form-group">
						     ...
						     <div class="col-sm-6">
						         <input class="form-control" id="click" placeholder="" name="click" required="" type="text">
						     </div>
						 </div> 
						 ...
						 <div class="form-group">
						     ...
						     <div class="col-sm-6">
						         <input class="form-control" id="des" placeholder="" name="keywords" required="" type="text">
						     </div>
						 </div> 
